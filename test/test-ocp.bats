...
@test "virt-capacity-benchmark" {
  ...
  for iteration in 0 1; do
    ...
    check_metric_recorded ./virt-capacity-benchmark/iteration-${iteration} restart-vms-${iteration} vmiLatency vmReadyLatency
    check_quantile_recorded ./virt-capacity-benchmark/iteration-${iteration} restart-vms-${iteration} vmiLatency VMReady
    check_metric_recorded ./virt-capacity-benchmark/iteration-${iteration} create-vms-${iteration} pvcLatency bindingLatency
    check_metric_recorded ./virt-capacity-benchmark/iteration-${iteration} create-vms-${iteration} dvLatency dvReadyLatency
    check_metric_recorded ./virt-capacity-benchmark/iteration-${iteration} snapshot-vms-${iteration} volumeSnapshotLatency vsReadyLatency
    done
